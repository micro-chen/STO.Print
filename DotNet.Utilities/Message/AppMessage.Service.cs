...
namespace DotNet.Utilities
{
    ...
    public partial class AppMessage
    {
        ...
        public static string FileService_ShareFolder = "公共文档";
        ...
        public static string FileService_GetObject = "取得实体";
        ...
        public static string ItemDetailsService_GetObject = "取得实体";
        ...
        public static string LogOnService_GetObject = "登入服务获取实体";
        ...
        public static string LogOnService_SignOut = "用户退出";
        ...
        public static string MessageService_GetUser = "取得用户信息";
        ...
        public static string ModuleService_GetObject = "取得实体";
        ...
        public static string OrganizeService_GetObject = "取得实体";
        ...
        public static string OrganizeService_GetArea = "取得区域列表";
        public static string OrganizeService_GetProvince = "取得省份列表";
        public static string OrganizeService_GetCity = "取得城市列表";
        public static string OrganizeService_GetDistrict = "取得县区列表";
        public static string OrganizeService_GetOrganizeByProvince = "按省份取得组织机构列表";
        public static string OrganizeService_GetOrganizeByCity = "按城市取得组织机构列表";
        public static string OrganizeService_GetOrganizeByDistrict = "按县区取得组织机构列表";
        ...
        public static string ParameterService_Add = "参数服务添加实体";
        public static string ParameterService_GetDataTableByParameter = "取得列表";
        public static string ParameterService_GetDataTableParameterCode = "按编号取得列表";
        public static string ParameterService_DeleteByParameter = "删除参数";
        public static string ParameterService_DeleteByParameterCode = "按参数编号删除";
        ...
        public static string PermissionService_GetObjectByCode = "按编号获取模块实体";
        public static string PermissionService_IsInRole = "用户是否在指定的角色中";
        public static string PermissionService_IsAuthorized = "该用户是否有相应的操作权限";
        public static string PermissionService_CheckPermissionByRole = "该角色是否有相应的操作权限";
        ...
        public static string PermissionService_GetPermissionDTByPermission = "用户的所有可授权范围(有授权权限的权限列表)";
        public static string PermissionService_GetRolePermissionIds = "取得角色权限主键数组";
        ...
        public static string PermissionService_GetRoleScopePermissionIds = "取得角色授权权限列表";
        public static string PermissionService_GrantRolePermissionScopes = "授予角色的授权权限范围";
        public static string PermissionService_RevokeRolePermissionScopes = "授予角色的授权权限范围";
        public static string PermissionService_ClearRolePermissionScope = "清除角色权限范围";
        public static string PermissionService_GetUserPermissionIds = "取得用户权力主键数组";
        ...
        public static string PermissionService_GetUserScopePermissionIds = "取得用户授权权限列表";
        public static string PermissionService_GrantUserPermissionScopes = "授予用户的授权权限范围";
        public static string PermissionService_RevokeUserPermissionScopes = "删除用户的授权权限范围";
        ...
        public static string PermissionService_GetPermissionListByUser = "取得用户有访问权限的菜单列表";
        ...
        public static string PermissionService_GetPermissionTreeUserIds = "获取用户权限树";
        ...
        public static string PermissionService_GetOrganizePermissionIds = "取得组织机构权限主键数组";
        ...
        public static string PermissionService_GetUserOrganizeScope = "获取用户的某个权限域的组织范围";
        public static string PermissionService_SetUserOrganizeScope = "设置用户某个权限的组织机构范围";
        public static string PermissionService_GetRoleOrganizeScope = "获取角色的某个权限域的组织范围";
        public static string PermissionService_SetRoleOrganizeScope = "设置角色某个权限的组织机构范围";

        public static string PermissionService_GetResourcePermissionIds = "取得资源权限主键数组";
        public static string PermissionService_GetUserPermissionScopeList = "取得用户资源权限列表";
        public static string PermissionService_GetRolePermissionScopeList = "取得角色资源权限列表";
        ...
        public static string RoleService_GetObject = "取得实体";
        ...
        public static string SequenceService_GetObject = "取得实体";
        ...
        public static string StaffService_GetObject = "取得实体";
        public static string StaffService_GetDataTableByIds = "取得职员列表";
        public static string StaffService_GetDataTableByCompany = "按公司取得列表";
        public static string StaffService_GetDataTableByDepartment = "按部门取得列表";
        public static string StaffService_GetDataTableByOrganize = "按组织机构取得列表";
        ...
        public static string UserService_GetObject = "取得实体";
        ...
        public static string UserService_GetRoleDataTable = "取得用户的角色列表";
