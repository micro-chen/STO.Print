...
namespace DotNet.Utilities
{
    ...
    public partial class BaseSystemInfo
    {
        ...
        /// 软件的名称
        /// </summary>
        public static string SoftFullName = "中天核心系统";

        /// <summary>
        /// 当前客户公司名称
        /// </summary>
        public static string CustomerCompanyName = "中通快递股份有限公司";
        ...
        public static void CreateOpenId()
        {
            ...
            {
                BaseSystemInfo.UserInfo.OpenId = openId;
            }
            // return openId;
        }
        ...
        {
            Thread thread = new Thread(CreateOpenId);
            thread.Start();
        }
    }
}