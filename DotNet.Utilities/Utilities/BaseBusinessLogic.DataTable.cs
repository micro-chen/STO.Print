...
namespace DotNet.Utilities
{
    ...
    public partial class BaseBusinessLogic
    {
        ...
        public static string GetDateTime(DataRow dr, string name)
        {
            ...
            if (!dr.IsNull(name))
            {
                DateTime DateTime = DateTime.Parse(dr[name].ToString());
        ...
        #region public static string FieldToList(DataTable dt) 表格字段转换为字符串列表
        /// <summary>
        /// 表格字段转换为字符串列表
        /// </summary>
        ...
        #region public static string FieldToList(DataTable dt, string name) 表格字段转换为字符串列表
        /// <summary>
        /// 表格字段转换为字符串列表
        /// </summary>
        /// <param name="dt">数据表</param>
        ...
        public static DataTable SetFilter(DataTable dt, string fieldName, string fieldValue, bool equals = false)
        {
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (equals)
                {
                    ...
                    {
                        if (dr[fieldName].ToString().Equals(fieldValue))
                        {
                            dr.Delete();
                        }
                    }
