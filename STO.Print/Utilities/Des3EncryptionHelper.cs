...
namespace STO.Print.Utilities
{
    ...
    /// 3DES（或称为Triple DES）是非常常用的对称加密算法，z，它相当于是对每个数据块应用三次DES加密算法。
    /// http://www.cnblogs.com/aoyeyuyan/p/5545398.html
    ///
    /// 修改纪录
    ///
    ///		  2016-07-06  版本：1.0 YangHengLian 创建主键，注意命名空间的排序。
    /// 
    /// 版本：1.0
    ///
    /// <author>
    ...
    /// </author>
    /// </summary>
    public class Des3EncryptionHelper
    {
        #region Static
        /// <summary>
        /// 使用3DES加密
        ...
        #region Ctor
        public Des3EncryptionHelper() { }
        public Des3EncryptionHelper(string _key)
        {
            this.key = _key;
        }
        /// <summary>
        ...
        public Des3EncryptionHelper(string _key, string _iniVector)
        {
            this.key = _key;
