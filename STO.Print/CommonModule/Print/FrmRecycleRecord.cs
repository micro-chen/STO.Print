...
namespace STO.Print
{
    ...
    /// 修改记录
    /// 
    ///     2016-06-11  版本：1.0 YangHengLian 创建
    /// 
    /// 版本：1.0
    ///
    /// <author>
    ...
    /// </author>
    /// </summary>
    public partial class FrmRecycleRecord : BaseForm
    {
        /// <summary>
        /// 定义Grid++Report报表主对象
        /// </summary>
        ...
        private void FrmPrintHistoryRecord_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                alertInfo.Show(this, "提醒消息", "所有删除的数据都在这里存放，误删除没有打印的单号从这里取消就可以了，老板再也不用担心单号浪费了");
            }
            catch (Exception ex)
            {
                ProcessException(ex);
