...
namespace STO.Print.AddBillForm
{
    ...
    /// </author>
    /// </summary>
    public partial class FrmAddZto180CODElecBill : BaseForm
    {
        readonly ZtoPrintBillManager _printBillManager = new ZtoPrintBillManager(BillPrintHelper.DbHelper);

        public FrmAddZto180CODElecBill()
        {
            InitializeComponent();
        }

        private void FrmAddZto180CODElecBill_Load(object sender, EventArgs e)
        {
            myEnterBillControl1.txtToPayMent.Enabled = false;
            myEnterBillControl1.txtGoodsPayment.Enabled = true;
            ...
            if (!string.IsNullOrEmpty(SelectedId))
            {
                ...
                // 需要绑定代收货款值
                myEnterBillControl1.txtGoodsPayment.Text = billEntity.GOODS_PAYMENT.ToString();
        ...
        /// <param name="e"></param>
        private void FrmAddZto180CODElecBill_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
