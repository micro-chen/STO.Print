...
namespace STO.Print.AddBillForm
{
    ...
    /// </author>
    /// </summary>
    public partial class FrmAddZtoBill : BaseForm
    {
        ...
        public void ClearText()
        {
            if (ckGetDefaultSendMan.Checked)
            {
                ...
                txtPrintMark.Text = string.Empty;
            }
            else
            {
        ...
        #region private void dgvSearchReceiveArea_Leave(object sender, EventArgs e) 光标离开收件区域，能够提取到大头笔和目的地

        /// <summary>
        /// 光标离开收件区域，能够提取到大头笔和目的地
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void dgvSearchReceiveArea_Leave(object sender, EventArgs e)
        {
            BindPrintMark();
        }
        #endregion
        ...
        #region private void BindPrintMark() 选择过收件地址后，能够提取到大头笔和目的地
        /// <summary>
        /// 选择过收件地址后，能够提取到大头笔和目的地
        /// </summary>
        private void dgvSearchReceiveArea_EditValueChanged(object sender, EventArgs e)
        {
            BindPrintMark();
        }
        ...
        private void ckChooseReceiveMan_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                var chooseReceiveMan = new FrmChooseReceiveMan();
        ...
        {
            FrmRecognitionAddress recognitionTaoBaoFrm = new FrmRecognitionAddress() { Owner = this };
        ...
        {
            txtReceiveMan.Text = userEntity.Realname;
            dgvSearchReceiveArea.Text = string.Format("{0}-{1}-{2}", userEntity.Province, userEntity.City, userEntity.County);
            txtReceiveDestination.Text = userEntity.Province;
            txtReceiveAddress.Text = userEntity.Address;
        ...
        private void chooseReceiveMan1_Load(object sender, EventArgs e)
        {
