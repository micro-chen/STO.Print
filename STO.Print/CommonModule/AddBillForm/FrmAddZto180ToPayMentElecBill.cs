...
namespace STO.Print.AddBillForm
{
    ...
    /// </author>
    /// </summary>
    public partial class FrmAddZto180ToPayMentElecBill : BaseForm
    {
        readonly ZtoPrintBillManager _printBillManager = new ZtoPrintBillManager(BillPrintHelper.DbHelper);

        public FrmAddZto180ToPayMentElecBill()
        {
            InitializeComponent();
        }
        ...
        /// <param name="e"></param>
        private void FrmAddZto180ToPayMentElecBill_Load(object sender, EventArgs e)
        {
            myEnterBillControl1.txtToPayMent.Enabled = true;
            ...
            if (!string.IsNullOrEmpty(SelectedId))
            {
                ...
                // 绑定到付金额
                myEnterBillControl1.txtToPayMent.Text = billEntity.TOPAYMENT.ToString();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FrmAddZto180ToPayMentElecBill_FormClosing(object sender, System.Windows.Forms.FormClosingEventArgs e)
        {
