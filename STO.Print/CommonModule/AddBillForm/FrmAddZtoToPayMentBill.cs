...
namespace STO.Print.AddBillForm
{
    ...
    /// </author>
    /// </summary>
    public partial class FrmAddZtoToPayMentBill : BaseForm
    {
        ...
        private ZtoPrintBillEntity BuildPrintBillEntity()
        {
            ...
            if (printBillEntity == null)
            {
                ...
                printBillEntity = new ZtoPrintBillEntity
                {
                    ...
                    TranFee = txtToPayMent.Text.Trim(),
            ...
            else
            {
                ...
                printBillEntity.TranFee = txtToPayMent.Text.Trim();
