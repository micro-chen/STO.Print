...
namespace STO.Print
{
    ...
    /// </author>
    /// </summary>
    public partial class FrmImportFreeExcel : BaseForm
    {

        public FrmImportFreeExcel()
        {
            InitializeComponent();
        }
        ...
        private void BtnImportClick(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtFileFullPath.Text))
            {
                ...
                {
                    var selectField = new FrmSelectFieldForImportFreeExcel(chooseDt);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void lblLookDemo_Click(object sender, EventArgs e)
        {
            ToolHelper.OpenBrowserUrl("http://note.youdao.com/share/?id=07aa02c70c02eebd753b750455b0c8ce&type=note");
        }
    }
}
