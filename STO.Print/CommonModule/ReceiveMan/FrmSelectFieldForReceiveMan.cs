...
namespace STO.Print
{
    ...
    /// </author>
    /// </summary>
    public partial class FrmSelectFieldForReceiveMan : BaseForm
    {
        readonly DataTable _execldt = new DataTable();

        public FrmSelectFieldForReceiveMan()
        {
            InitializeComponent();
        }

        public FrmSelectFieldForReceiveMan(DataTable excelDataTable)
        {
            InitializeComponent();
