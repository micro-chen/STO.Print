...
namespace DotNet.Business
{
    ...
    public partial class BaseManager : IBaseManager
    {
        ...
        /// <param name="order">排序字段</param>
        /// <returns>数据表</returns>
        public virtual List<TModel> ExecuteReaderByPage<TModel>(out int recordCount, int pageIndex, int pageSize,
            string whereClause, IDbDataParameter[] dbParameters, string order) where TModel : new()
        {
            return
                ExecuteReaderByPage(out recordCount, pageIndex, pageSize, whereClause, dbParameters, order)
                    .ToList<TModel>();
        }
        ...
        /// <param name="selectField">选择哪些字段</param>
        /// <returns>数据表</returns>
        public virtual List<TModel> ExecuteReaderByPage<TModel>(out int recordCount, int pageIndex = 0, int pageSize = 20,
        ...
        {
            return
                ExecuteReaderByPage(out recordCount, pageIndex, pageSize, sortExpression, sortDire, tableName,
