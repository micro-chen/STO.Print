...
namespace DotNet.Business
{
    ...
    public partial class DbLogic
    {
        ...
        #region public static IDataReader GetDataTableByPage(IDbHelper dbHelper, out int recordCount, int pageIndex = 0, int pageSize = 20, string sortExpression = null, string sortDire = null, string tableName = null, string whereClause = null, string selectField = null)
        /// <summary>
        /// 使用存储过程获取分页数据
        /// </summary>
        ...
        /// <returns></returns>
        public static IDataReader GetDataReaderByPage(IDbHelper dbHelper, out int recordCount, int pageIndex = 0, int pageSize = 20, string sortExpression = null, string sortDire = null, string tableName = null, string whereClause = null, string selectField = null)
        {
        ...
        /// <param name="selectField">查询字段</param>
        /// <returns></returns>
        public static List<TModel> GetDataReaderByPage<TModel>(IDbHelper dbHelper, out int recordCount, int pageIndex = 0,
        ...
        {
            return
                GetDataReaderByPage(dbHelper, out recordCount, pageIndex, pageSize, sortExpression, sortDire, tableName,
        ...
        */
        ...
        #region public static IDataReader GetDataTableByPage(IDbHelper dbHelper, int recordCount, int pageIndex, int pageSize, string sqlQuery, IDbDataParameter[] dbParameters, string sortExpression = null, string sortDire = null)
        /// <summary>
        /// 分页获取指定数量的数据
        /// </summary>
        /// <param name="dbHelper">数据源</param>
        ...
        /// <param name="sortDire">排序</param>
        /// <returns></returns>
        public static IDataReader GetDataReaderByPage(IDbHelper dbHelper, int recordCount, int pageIndex, int pageSize, string sqlQuery, IDbDataParameter[] dbParameters, string sortExpression = null, string sortDire = null)
        {
            if (string.IsNullOrEmpty(sortExpression))
            {
                sortExpression = BaseBusinessLogic.FieldCreateOn;
        ...
        /// <param name="sortDire">排序</param>
        /// <returns></returns>
        public static List<TModel> GetDataReaderByPage<TModel>(IDbHelper dbHelper, int recordCount, int pageIndex, int pageSize,
            string sqlQuery, IDbDataParameter[] dbParameters, string sortExpression = null, string sortDire = null) where TModel : new()
        {
            return
                GetDataReaderByPage(dbHelper, recordCount, pageIndex, pageSize, sqlQuery, dbParameters, sortExpression,
        ...
        #region public static IDataReader GetDataTableByPage(IDbHelper dbHelper, string tableName, string selectField, int pageIndex, int pageSize, string conditions, string orderBy)
        /// <summary>
        /// Oracle 获取分页数据
        /// </summary>
        ...
        /// <returns>数据表</returns>
        public static IDataReader GetDataReaderByPage(IDbHelper dbHelper, string tableName, string selectField, int pageIndex, int pageSize, string conditions, string orderBy)
        {
            return GetDataReaderByPage(dbHelper, tableName, selectField, pageIndex, pageSize, conditions, null, orderBy);
        }
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns>数据表</returns>
        public static List<TModel> GetDataReaderByPage<TModel>(IDbHelper dbHelper, string tableName, string selectField,
            int pageIndex, int pageSize, string conditions, string orderBy) where TModel : new()
        {
            return
                GetDataReaderByPage(dbHelper, tableName, selectField, pageIndex, pageSize, conditions, orderBy)
                    .ToList<TModel>();
        }

        #endregion

        #region public static IDataReader GetDataTableByPage(IDbHelper dbHelper, string tableName, string selectField, int pageIndex, int pageSize, string conditions, IDbDataParameter[] dbParameters, string orderBy, string currentIndex = null)
        /// <summary>
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns>数据表</returns>
        public static IDataReader GetDataReaderByPage(IDbHelper dbHelper, string tableName, string selectField, int pageIndex, int pageSize, string conditions, IDbDataParameter[] dbParameters, string orderBy, string currentIndex = null)
        {
            string sqlStart = ((pageIndex - 1) * pageSize).ToString();
            string sqlEnd = (pageIndex * pageSize).ToString();
    ...
    , tableName, conditions, orderBy, sqlEnd, sqlStart);
        ...
        {
            return
                GetDataReaderByPage(dbHelper, tableName, selectField, pageIndex, pageSize, conditions, dbParameters,
        ...
        #region public static IDataReader GetDataTableByPage(IDbHelper dbHelper, out int recordCount, string tableName, string selectField, int pageIndex, int pageSize, string conditions, List<KeyValuePair<string, object>> dbParameters, string orderBy)
        /// <summary>
        /// 获取分页数据（防注入功能的） 
        ...
        /// <param name="orderBy">排序字段</param>
        /// <returns>数据表</returns>
        public static List<TModel> GetDataReaderByPage<TModel>(IDbHelper dbHelper, out int recordCount, string tableName,
        ...
        {
            return GetDataReaderByPage(dbHelper, out recordCount, tableName, selectField, pageIndex, pageSize, conditions, dbParameters, orderBy).ToList<TModel>();
        }
