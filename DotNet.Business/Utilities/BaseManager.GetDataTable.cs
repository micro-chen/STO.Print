...
namespace DotNet.Business
{
    ...
    public partial class BaseManager : IBaseManager
    {
        ...
        public virtual DataTable GetDataTableByWhere(string where = null, IDbDataParameter[] dbParameters = null, string order = null)
        {
            ...
            return DbHelper.Fill(sqlQuery, dbParameters);
        }
        ...
        {
            return GetDataTableByWhere(where);
        }
