...
namespace DotNet.Business
{
    ...
    public partial class BaseWorkFlowCurrentManager : BaseManager, IBaseManager
    {
        public int AuditComplete(string[] currentIds, string auditIdea)
        {
            ...
            {
                result += AuditComplete(currentIds[i], auditIdea);
            }
            return result;
        }
        ...
        {
            BaseWorkFlowCurrentEntity currentEntity = this.GetObject(currentId);
            // 1.记录审核时间、审核人、审核意见
            ...
            currentEntity.Description = "审批完成";
            ...
            // 3.更新当前表
            this.UpdateObject(currentEntity);
