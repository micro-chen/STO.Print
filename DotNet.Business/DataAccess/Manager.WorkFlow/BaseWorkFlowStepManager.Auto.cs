...
namespace DotNet.Business
{
    ...
    public partial class BaseWorkFlowStepManager : BaseManager, IBaseManager
    {
        ...
        {
            return this.AddObject(BaseWorkFlowStepEntity);
        }
        ...
        {
            return this.UpdateObject(BaseWorkFlowStepEntity);
        }
        ...
        public BaseWorkFlowStepEntity GetObject(int id)
        {
        ...
        /// </summary>
        /// <param name="id">主键</param>
        public BaseWorkFlowStepEntity GetObject(string id)
        {
            return BaseEntity.Create<BaseWorkFlowStepEntity>(this.ExecuteReader(new KeyValuePair<string, object>(BaseWorkFlowStepEntity.FieldId, id)));
            // return BaseEntity.Create<BaseWorkFlowStepEntity>(this.GetDataTable(new KeyValuePair<string, object>(BaseWorkFlowStepEntity.FieldId, id)));
        }
        ...
        /// </summary>
        /// <param name="BaseWorkFlowStepEntity">实体</param>
        public int UpdateObject(BaseWorkFlowStepEntity BaseWorkFlowStepEntity)
        {
            SQLBuilder sqlBuilder = new SQLBuilder(DbHelper);
            sqlBuilder.BeginUpdate(this.CurrentTableName);
            this.SetObject(sqlBuilder, BaseWorkFlowStepEntity);
            if (UserInfo != null)
            {
                sqlBuilder.SetValue(BaseWorkFlowStepEntity.FieldModifiedUserId, UserInfo.Id);
                sqlBuilder.SetValue(BaseWorkFlowStepEntity.FieldModifiedBy, UserInfo.RealName);
