...
namespace DotNet.Business
{
    ...
    /// </author> 
    /// </summary>
    public partial class BaseUserBillManager : BaseWorkFlowBillTemplateManager
    {
        ...
        public DataTable SearchBill(string userId, string categoryId, string categorybillFullName, string searchValue, bool? enabled, bool? deletionStateCode)
        {
            ...
            if (!string.IsNullOrEmpty(categoryId))
            {
                ...
                string categoryIds = BaseBusinessLogic.FieldToList(dt, BaseWorkFlowBillTemplateEntity.FieldId);
