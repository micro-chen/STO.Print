...
namespace DotNet.Business
{
    ...
    public partial class BaseWorkFlowBillTemplateManager : BaseManager, IBaseManager
    {
        ...
        {
            return this.AddObject(baseWorkFlowBillTemplateEntity);
        }
        ...
        {
            return this.UpdateObject(baseWorkFlowBillTemplateEntity);
        }
        ...
        public BaseWorkFlowBillTemplateEntity GetObject(string id)
        {
            return BaseEntity.Create<BaseWorkFlowBillTemplateEntity>(this.ExecuteReader(new KeyValuePair<string, object>(BaseWorkFlowBillTemplateEntity.FieldId, id)));
            // return BaseEntity.Create<BaseWorkFlowBillTemplateEntity>(this.GetDataTable(new KeyValuePair<string, object>(BaseWorkFlowBillTemplateEntity.FieldId, id)));
        }
        ...
        /// </summary>
        /// <param name="baseWorkFlowBillTemplateEntity">实体</param>
        public string AddObject(BaseWorkFlowBillTemplateEntity baseWorkFlowBillTemplateEntity)
        {
            ...
            this.SetObject(sqlBuilder, baseWorkFlowBillTemplateEntity);
            if (UserInfo != null) 
            { 
        ...
        /// </summary>
        /// <param name="baseWorkFlowBillTemplateEntity">实体</param>
        public int UpdateObject(BaseWorkFlowBillTemplateEntity baseWorkFlowBillTemplateEntity)
        {
        ...
        // 这个是声明扩展方法
        partial void SetObjectExpand(SQLBuilder sqlBuilder, BaseWorkFlowBillTemplateEntity baseWorkFlowBillTemplateEntity);
