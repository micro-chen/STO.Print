...
namespace DotNet.Business
{
    ...
    {
        #region private static List<BaseItemDetailsEntity> GetEntities(string tableName) 获取选项表明细，从缓存读取
        /// <summary>
        /// 获取选项表明细，从缓存读取
        /// </summary>
        private static List<BaseItemDetailsEntity> GetEntities(string tableName)
        {
