...
namespace DotNet.Business
{
    ...
    /// </author>
    /// </summary>
    public partial class BaseOrganizeGisManager : BaseManager //, IBaseOrganizeExpressManager
    {
        ...
        public void UpdateEntityLog(BaseOrganizeGisEntity newEntity, BaseOrganizeGisEntity oldEntity,string tableName = null)
        {
            ...
            foreach (var property in typeof(BaseOrganizeGisEntity).GetProperties())
            {
                ...
                record.TableDescription = FieldExtensions.ToDescription(typeof(BaseOrganizeGisEntity), "TableName");
