    ...
    public partial class UserService : IUserService
    {
        ...
        {			
            ...
            ServiceUtil.ProcessUserCenterReadDb(userInfo, parameter, (dbHelper) =>
			{
				...
				{
					entityList = userManager.GetList<BaseUserEntity>(new KeyValuePair<string, object>(BaseUserEntity.FieldDeletionStateCode, 0)
        ...
        {			
            ...
            ServiceUtil.ProcessUserCenterReadDb(userInfo, parameter, (dbHelper) =>
			{
				...
				if(string.IsNullOrEmpty(departmentId))
				{
					dt = userManager.GetDataTable(new KeyValuePair<string, object>(BaseUserEntity.FieldDeletionStateCode, 0)
					, 200, BaseUserEntity.FieldSortCode);
				}
				else
				{
