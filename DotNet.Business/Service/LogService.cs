...
namespace DotNet.Business
{
    ...
    public class LogService : ILogService
    {
            ...
            ServiceUtil.ProcessUserCenterReadDb(userInfo, parameter, (dbHelper) =>
			{
				...
				else
				{
					...
					else
					{
						...
						string[] userIds = BasePermissionScopeManager.GetUserIds(userInfo.SystemCode, userInfo.Id, "Resource.ManagePermission");
        ...
        {			
            ...
            ServiceUtil.ProcessUserCenterReadDb(userInfo, parameter, (dbHelper) =>
			{
				...
				else
				{
					...
					string[] userIds = permissionScopeManager.GetUserIds(userInfo.SystemCode, userInfo.Id, "Resource.ManagePermission");
        ...
        #region public DataTable SearchUserByPage(BaseUserInfo userInfo, out int recordCount, int pageIndex, int pageSize, string permissionCode, string whereClause, string sort = null);
        /// <summary>
        /// 查询用户列表
        /// </summary>
        /// <param name="userInfo">用户</param>
        ...
        {			
            ...
            ServiceUtil.ProcessUserCenterWriteDb(userInfo, parameter, (dbHelper) =>
			{
				...
				// result = manager.Delete(new KeyValuePair<string, object>(BaseLogEntity.FieldId, id));
			});
			return result;
        }
        #endregion
