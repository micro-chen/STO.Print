...
namespace DotNet.Business
{
    ...
    public partial class TAB_EMPLOYEEManager : BaseManager, IBaseManager
    {
        ...
        public TAB_EMPLOYEEManager()
        {
            ...
            {
                string k8Dbconnection = ConfigurationManager.AppSettings["K8DbConnection"];
                //IDbHelper k8DbHelper = DbHelperFactory.GetHelper(CurrentDbType.Oracle, k8Dbconnection);
                //base.dbHelper = DbHelperFactory.GetHelper(BaseSystemInfo.BusinessDbType, BaseSystemInfo.BusinessDbConnection);
                base.dbHelper = DbHelperFactory.GetHelper(BaseSystemInfo.BusinessDbType, k8Dbconnection);
            }
        ...
        {
            return BaseEntity.Create<TAB_EMPLOYEEEntity>(this.ExecuteReader(new KeyValuePair<string, object>(this.PrimaryKey, id)));
