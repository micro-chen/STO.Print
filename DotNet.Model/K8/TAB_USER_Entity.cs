//-----------------------------------------------------------------------
// <copyright file="TAB_USEREntity.cs" company="Hairihan">
...
namespace DotNet.Model
{
    ...
    /// </author>
    /// </summary>
    public partial class TAB_USEREntity : BaseEntity
    {
        private Decimal id;
        /// <summary>
        /// 主键
       ...
       [Display(Name = "备注")] 
        ...
        {
            GetFromExpand(dr);
            ID = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_ID]);
            COMPUT_ID = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_COMPUT_ID]);
            EMPLOYEE_CODE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_EMPLOYEE_CODE]);
            OWNER_ROLE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_OWNER_ROLE]);
            BL_REC_PLACARD = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_BL_REC_PLACARD]);
            USER_SITE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_USER_SITE]);
            ROLEID = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_ROLEID]);
            MODIFIER = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_MODIFIER]);
            USER_WEBPOWER = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_USER_WEBPOWER]);
            OWNER_CENTER = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_OWNER_CENTER]);
            MODIFIER_CODE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_MODIFIER_CODE]);
            CREATE_SITE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_CREATE_SITE]);
            IM_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_IM_NAME]);
            USER_PART = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_USER_PART]);
            BL_CHECK_COMPUTER = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_BL_CHECK_COMPUTER]);
            DEPT_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_DEPT_NAME]);
            //USER_PASSWORD = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_USER_PASSWORD]);
            USER_PASSWD = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_USER_PASSWD]);
            CALL_CENTER_ID = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_CALL_CENTER_ID]);
            EMPLOYEE_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_EMPLOYEE_NAME]);
            DELETIONSTATECODE = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_DELETIONSTATECODE]);
            OWNER_GROUP = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_OWNER_GROUP]);
            MODIFY_SITE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_MODIFY_SITE]);
            BL_LOCK_FLAG = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_BL_LOCK_FLAG]);
            OWNER_SITE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_OWNER_SITE]);
            CREATE_DATE = BaseBusinessLogic.ConvertToDateTime(dr[TAB_USEREntity.Field_CREATE_DATE]);
            CREATE_USER = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_CREATE_USER]);
            USER_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_USER_NAME]);
            REMARK = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_REMARK]);
            BL_AO = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_BL_AO]);
            BL_TYPE = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_BL_TYPE]);
            LOGINNAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_LOGINNAME]);
            OWNER_GROUP = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_OWNER_GROUP]);
            MOBILE = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_MOBILE]);
            ONLY_USER_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_ONLY_USER_NAME]);
            ID_CARD = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_ID_CARD]);
            MODIFIER_DATE = BaseBusinessLogic.ConvertToDateTime(dr[TAB_USEREntity.Field_MODIFIER_DATE]);


            CHECK_NAME_DATE = BaseBusinessLogic.ConvertToDateTime(dr[TAB_USEREntity.Field_CHECK_NAME_DATE]);
            BL_CHECK_NAME = BaseBusinessLogic.ConvertToDecimal(dr[TAB_USEREntity.Field_BL_CHECK_NAME]);
            POSITION_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_POSITION_NAME]);
            REAL_NAME = BaseBusinessLogic.ConvertToString(dr[TAB_USEREntity.Field_REAL_NAME]);
            USER_DATE = BaseBusinessLogic.ConvertToDateTime(dr[TAB_USEREntity.Field_USER_DATE]);
            return this;
        }
