...
namespace DotNet.IService
{
    ...
    public interface IFileService
    {
        ...
        /// <returns>主键</returns>
        [OperationContract]
        string UplaodeByBlock(BaseUserInfo userInfo, string folderId, string fileName, byte[] file, int filesize, bool enabled);
        ...
        /// <returns></returns>
        [OperationContract]
        string UplaodeByBlockUpdate(BaseUserInfo userInfo, string Id, string fileName, int length, byte[] file);
        /// <summary>
        /// 获取实体
        /// </summary>
        /// <param name="userInfo">用户</param>
