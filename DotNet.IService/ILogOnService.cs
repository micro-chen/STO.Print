...
namespace DotNet.IService
{
    ...
    public interface ILogOnService
    {
        ...
        [OperationContract]
        UserLogOnResult UserLogOn(string taskId, BaseUserInfo userInfo, string userName, string password, string openId, bool createOpenId);
        ...
        /// <returns>登录实体类</returns>
        [OperationContract]
        UserLogOnResult LogOnByCompany(string taskId, BaseUserInfo userInfo, string companyName, string userName, string password, string openId, bool createOpenId);
        ...
        /// <returns>登录实体类</returns>
        [OperationContract]
        UserLogOnResult LogOnByNickName(string taskId, BaseUserInfo userInfo, string nickName, string password, string openId, bool createOpenId);
