...
namespace DotNet.IService
{
    ...
    public partial interface IMobileService
    {
        ...
        /// 获取可发送短信的余额
        /// </summary>
        /// <param name="result">当前用户信息</param>
        ...
        /// <returns>主键</returns>
        [OperationContract]
        int SendMobileMessage(BaseUserInfo userInfo, string mobiles, string message, bool hotline, bool confidentialInformation, string channel);
